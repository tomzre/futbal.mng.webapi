...
namespace Futbal.Mng.Infrastructure.Migrations
{
    ...
    [Migration("20190630172855_NewMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Futbal.Mng.Domain.Event.OccuringEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Futbal.Mng.Domain.Event.OccuringEvent", b =>
                {
                    ...
                    b.OwnsMany("Futbal.Mng.Domain.Event.Attendee", "Attendees", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .ValueGeneratedOnAdd();

                            b1.Property<Guid>("OccuringEventId");

                            b1.HasKey("UserId");

                            b1.HasIndex("OccuringEventId");

                            b1.ToTable("Attendee");

                            b1.HasOne("Futbal.Mng.Domain.Event.OccuringEvent")
                                .WithMany("Attendees")
                                .HasForeignKey("OccuringEventId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
            ...
            modelBuilder.Entity("Futbal.Mng.Domain.UserManagement.User", b =>
                {
                    b.HasOne("Futbal.Mng.Domain.Event.Game")
                        .WithMany("Attendees")
                        .HasForeignKey("GameId");
                });
